...
pokedex.set("Charizard", new Pokemon("Charizard", ["fire"], [moves.get("Inferno"), moves.get("Flare Blitz"), moves.get("Flamethrower"), null], "charizardfront.png", "charizardback.png", new Stat(25, 30, 25, 20), new Stat(250, 325, 275, 200), 5))
...
pokedex.set("Zapdos", new Pokemon("Zapdos", ["electric"], [moves.get("Zap Cannon"), moves.get("Thunder"), moves.get("Spark"), null], "zapdosfront.png", "zapdosback.png", new Stat(30, 45, 30, 35), new Stat(300, 400, 400, 250), 1))