...
pokedex.set("Raichu", new Pokemon("Raichu", ["electric"], [moves.get("Thunderbolt"), moves.get("Scratch"), moves.get("Thunderbolt"), moves.get("Scratch")], "raichufront.png", "raichuback.png", new Stat(20, 25, 20), new Stat(250, 300, 2050)))
