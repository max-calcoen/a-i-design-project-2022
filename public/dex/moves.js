...
moves.set("Zap Cannon", new Move("Zap Cannon", "electric", true, 200, 1, 85))
moves.set("Thunder", new Move("Thunder", "electric", false, 110, 40, 100))
moves.set("Egg Bomb", new Move("Egg Bomb", "normal", false, 100, 15, 10))
moves.set("Body Slam", new Move("Body Slam", "normal", false, 55, 30, 100))
moves.set("Dazzling Gleam", new Move("Dazzling Gleam", "fairy", false, 200, 10, 50))
moves.set("Moonblast", new Move("Moonblast", "fairy", false, 130, 10, 100))
moves.set('Poison Fang', new Move("Poison Fang", "poison", true, 50, 25, 100))
moves.set("Poison Jab", new Move("Poison Jab", "poison", true, 80, 15, 100))
moves.set("Earthquake", new Move("Earthquake", "ground", false, 140, 10, 80))
moves.set("Fissure", new Move("Fissure", "ground", false, 500, 5, 30))